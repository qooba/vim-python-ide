...
if [ -d "$VIM/bundle/YouCompleteMe" ]; then
    mkdir /root/.vim/bundle/YouCompleteMe/third_party/ycmd/clang_archives/
    curl -L https://dl.bintray.com/ycm-core/libclang/libclang-9.0.0-x86_64-unknown-linux-gnu.tar.bz2 -o /root/.vim/bundle/YouCompleteMe/third_party/ycmd/clang_archives/libclang-9.0.0-x86_64-unknown-linux-gnu.tar.bz2
